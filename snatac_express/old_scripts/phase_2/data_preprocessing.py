...
def load_independent_gex_(test_gex_matrix):
    ...
    sparse_gex_matrix = sparse_gex_matrix.astype(np.uint8) # mem efficient datatype
    gm_dense = sparse_gex_matrix.toarray()
    genes = np.genfromtxt("/storage/home/mfisher42/scProjects/Predict_GEX/Multitest_kfoldcv_Aggreg95featselect_hyperparam_10perc_parallel_12072023/test_data/script-output/sparse_gex_matrix_rownames.txt", dtype=str)
    col_names = np.genfromtxt("/storage/home/mfisher42/scProjects/Predict_GEX/Multitest_kfoldcv_Aggreg95featselect_hyperparam_10perc_parallel_12072023/test_data/script-output/sparse_gex_matrix_colnames.txt", dtype=str, comments = "+")
