...
if __name__ == "__main__":
    ...
    for gene in genes:
        ...
        if len(gene_files) == 0:
            ...
            # aggregate
            exclLR_alpha_summary = get_aggregates(gene, results_dir)
            # find SNP overlaps, incl LR
            #exclLR_output_summary.to_csv(str(gene_path + "/snp_overlaps_aggregated_exclLR.csv"), index = False)
            #get_overlaps_all(gene, exclLR_output_summary, results_dir)
