...
os.chdir("/storage/home/hcoda1/6/mfisher42/scratch/scATAC_Express/Multitest_kfoldcv_95featselect_hyperparam_10perc_parallel_11102023")
...
def build_models(gene):
    ...
    if len(peak_set) < 3:
        ...
        #alpha_summary.to_csv("/storage/home/hcoda1/6/mfisher42/scratch/scATAC_Express/Multitest_kfoldcv_95featselect_hyperparam_10perc_parallel_11102023/alpha_summary.csv", index=False)
    #return alpha_summary


# ============================================
#def check_peaks(gene):
#    global peak_df, gex_df, pb_keep, test_peak_df, test_gex_df, pb_test, outdir, alpha_summary
#    print("Extracting information for " + gene)
#    window = genes_df.loc[genes_df["gene"] == gene, "window"].iloc[0]
#    # subset gene and region from peak_df and gex_df
#    train_gene_peaks = subset_peaks(peak_df, window)
#    train_gene_exp = subset_gex(gex_df, gene)
#    test_gene_peaks = subset_peaks(test_peak_df, window)
#    test_gene_gex = subset_gex(test_gex_df, gene)
...
if __name__ == "__main__":
    ...
    outdir = "/storage/home/hcoda1/6/mfisher42/scratch/scATAC_Express/Multitest_kfoldcv_95featselect_hyperparam_10perc_parallel_11102023/Results/"
