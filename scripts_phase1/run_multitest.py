...
def build_models(gene):
    ...
    if len(peak_set) < 3:
        ...
        #alpha_summary.to_csv("/storage/home/hcoda1/6/mfisher42/scratch/scATAC_Express/SLE_Genes_02062024/Multitest_kfoldcv_95featselect_hyperparam_10perc_parallel_02082024/alpha_summary.csv", index=False)
